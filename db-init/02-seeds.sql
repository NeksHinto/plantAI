...
VALUES 
    ...
    (1, 'Balcón', FALSE, '28.0°C', 'https://images.homify.com/v1512602028/p/photo/image/2350742/DSC_0405-Editar-Editar.jpg'),
    
    -- Nicole (id: 2) armó su espacio en el Dormitorio
    (2, 'Dormitorio', TRUE, '20.0°C', 'https://img.magnific.com/fotos-premium/acogedor-dormitorio-luminoso-plantas-interiordiseno-interior-casadiseno-biofilicoconcepto-jungla-urbana_1033579-214650.jpg?semt=ais_hybrid&w=740&q=80'),
    
    -- Dylan (id: 3) tiene dos habitaciones: Living y Balcón
    (3, 'Living', TRUE, '22.5°C', 'https://cl.habcdn.com/photos/project/big/salon-con-plantas-1163533-158823.jpg'),
    (3, 'Balcón', FALSE, '28.0°C', 'https://images.homify.com/v1512602028/p/photo/image/2350742/DSC_0405-Editar-Editar.jpg'),
    
    -- Agustín (id: 4) solo tiene un Living
    (4, 'Living', TRUE, '22.5°C', 'https://cl.habcdn.com/photos/project/big/salon-con-plantas-1163533-158823.jpg');
...
VALUES
    ...
    (1, 'no disease', 99.99, 'Buen estado general. Asegúrate de no regar en exceso.'),
    
    -- Diagnóstico para 'Lazo' (plant_id: 2)
    (2, 'no disease', 95.00, 'La planta está en perfectas condiciones de salud.'),
    
    -- Diagnóstico para 'El Güembé' (plant_id: 3 - Simulación de plaga)
    (3, 'spider_mites', 89.50, 'Aislar la planta. Aplicar aceite de neem o jabón potásico sobre las hojas afectadas cada 7 días.'),
    
    -- Diagnóstico para 'Jazmín' (plant_id: 4)
    (4, 'no disease', 99.00, 'Buen estado general.'),
    
    -- Diagnóstico para 'Serrucho' (plant_id: 5)
    (5, 'no disease', 98.50, 'La planta está en perfectas condiciones de salud.');